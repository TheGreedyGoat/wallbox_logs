...
mixin _$WallBoxTransaction {
 ...
 bool get isBilled; ChargingEvent get start; ChargingEvent get stop; set stop(ChargingEvent value);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WallBoxTransaction&&(identical(other.isBilled, isBilled) || other.isBilled == isBilled)&&(identical(other.start, start) || other.start == start)&&(identical(other.stop, stop) || other.stop == stop));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,isBilled,start,stop);

@override
String toString() {
  return 'WallBoxTransaction(isBilled: $isBilled, start: $start, stop: $stop)';
}
...
@useResult
$Res call({
 ChargingEvent start, ChargingEvent stop, bool isBilled
});
...
/// Create a copy of WallBoxTransaction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? start = null,Object? stop = null,Object? isBilled = null,}) {
...
as ChargingEvent,isBilled: null == isBilled ? _self.isBilled : isBilled // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
