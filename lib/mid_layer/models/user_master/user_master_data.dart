...
class UserMasterData with _$UserMasterData implements DatabaseModel {
  ...
  static UserMasterData? getByKey(String key) => repo.getById(key);
  ...
  static const unExisting = '[exisiert nicht]';
  ...
  static String nameOfTagID(String tagID) =>
      repo.getById(tagID)?.fullName ?? unExisting;
  ...
  Map<DateTime, List<WallBoxTransaction>> transactionsByMonth([
    ...
    for (int i = 0; i < all.length; i++) {
      ...
      if (!includePaid && currentTransaction.isBilled) continue;
  ...
  String get address =>
      '${streetAndNumber ?? '_______________'}\n${postCode ?? '_______________'} ${city ?? '_______________'}';
}
